	...
	>
		<template #body-header>
			<div class="flex items-center mb-5">
				...
				<Badge
					v-if="currentTab === 'password' && password.new_password !== password.confirm_password"
					class="ml-4"
					theme="red"
				>
					Password Mismatch
							...
							<div v-else class="mb-4">
								<div class="flex items-center">
									<img
										...
										class="h-[50px] w-[50px] rounded-full border-4 border-white object-cover"
									/>
...
watch(
	...
	(newVal) => {
		if (newVal) {
			...
			if (newVal.user_image) {
				imageResource.submit({ image: newVal.user_image })
			}
			isDirty.value = false
		}
	}
